/*
	dynamic_aabb_tree.c — BVH for broadphase. Ported 1-a-1 from qu3e
	q3DynamicAABBTree.cpp. Nodes live in a pool with a free list; insert uses
	surface-area heuristic; balance is a single-rotation AVL-style.
*/
#include <assert.h>
#include <math.h>
#include <stddef.h>
