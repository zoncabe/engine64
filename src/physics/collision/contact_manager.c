/*
	contact_manager.c — maintains the list of active ContactConstraints,
	drives broadphase pair generation, and refreshes contacts each step.
	Ported 1-a-1 from qu3e q3ContactManager.cpp.
*/
#include <stddef.h>
...
#include "physics/geometry/half_space.h"   /* vector3_computeBasis */
