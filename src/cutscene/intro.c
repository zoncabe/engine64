	...
	.section = {
		[0] = {
			.element = {
				...
				[INTRO_ZONCABE]   = { .type = DRAW_SPRITE,    .position = { 0.0f, 0.0f }, .scale = { 1.0f, 1.0f },     .sprite    = { SPRITE_ZONCABE },   .is_hidden = true },
...
static const ScreenAnimationTrack intro_track[] = {
	...
	{ .target_bool = &intro_screen.section[0].element[INTRO_ZONCABE].is_hidden,   .from_bool = true, .to_bool = false, .delay = 7.00f, .duration = 3.00f },
