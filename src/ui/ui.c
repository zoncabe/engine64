...
static RenderContext main_menu_screen = {
	.element = {
		[0]  = { DRAW_RECTANGLE, .rectangle = { SHAPE_FILL_GRADIENT, { 0.0f, 0.0f }, { 320.0f, 240.0f }, .gradient = { RGBA32(201, 121, 25, 255), RGBA32(223, 175, 117, 255), RGBA32(223, 175, 117, 255), RGBA32(201, 121, 25, 255) } } },
		...
		[8]  = { DRAW_SPRITE,    .sprite    = { SPRITE_BTN_A,   { 102.0f, 216.0f }, { 0.60f, 0.60f } } },
		[9]  = { DRAW_SPRITE,    .sprite    = { SPRITE_D_UP,    {  43.0f, 217.0f }, { 0.48f, 0.48f } } },
		[10] = { DRAW_SPRITE,    .sprite    = { SPRITE_D_DOWN,  {  53.0f, 217.0f }, { 0.48f, 0.48f } } },
		[11] = { DRAW_SPRITE,    .sprite    = { SPRITE_GORILLA, { 170.0f,   0.0f }, { 1.0f,  1.0f  } } },
	},
	.element_count = 12,
};
...
static RenderContext pause_screen = {
	.element = {
		[0]  = { DRAW_RECTANGLE, .rectangle = { SHAPE_FILL_GRADIENT, { 0.0f, 0.0f }, { 320.0f, 240.0f } } },
		...
		[7]  = { DRAW_SPRITE,    .sprite    = { SPRITE_D_UP,   { 0.0f, 186.0f }, { 0.48f, 0.48f } } },
		[8]  = { DRAW_SPRITE,    .sprite    = { SPRITE_D_DOWN, { 0.0f, 187.0f }, { 0.48f, 0.48f } } },
		[9]  = { DRAW_SPRITE,    .sprite    = { SPRITE_BTN_A,  { 0.0f, 201.0f }, { 0.60f, 0.60f } } },
		[10] = { DRAW_SPRITE,    .sprite    = { SPRITE_BTN_B,  { 0.0f, 216.0f }, { 0.60f, 0.60f } } },
	},
	.element_count = 11,
};
...
{
	if (game->state != GAME_STATE_PAUSE && game->state != GAME_STATE_GAMEPLAY) return;
	...
	for (int i = 0; i < 3; i++) {
		if (game->previous_state != GAME_STATE_PAUSE)
